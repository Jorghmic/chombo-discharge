...
def write_slurm_file(input_file):
    ...
    slurm_file = Path(f"{JOB_NAME}_{input_stem}.slurm")
    ...
    print(f"[INFO] wrote SLURM file: {slurm_file.resolve()}")
...
def main(phases):
    ...
    for idx, phase in enumerate(phases):
        ...
        text = set_param(text, PARAM_MAXSTEPS, int(new_max_steps))
