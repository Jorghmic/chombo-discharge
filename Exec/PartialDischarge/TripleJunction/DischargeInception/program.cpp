...
int main(int argc, char* argv[]){
  ...
  LookupTable1D<> ionizationData = DataParser::fractionalFileReadASCII("transport_data.dat",
                                                                       "E/N (Td)	Townsend ioniz. coef. alpha/N (m2)",
                                                                       "");
  LookupTable1D<> attachmentData = DataParser::fractionalFileReadASCII("transport_data.dat",
